...
function getGardent() {
    ...
    axios.get(`${store.api}/api/lake`, store.header)
        .then(response => {
...
function getGardentSlot() {
    ...
    axios.get(`${store.api}/api/lake/slot`, store.header)
        .then(response => {
...
function deleteGardent() {
    ...
    axios.delete(`${store.api}/api/lake`, store.header)
        .then(response => {
            gardent.value = null
            store.noti = {
                'title': 'success',
...
function buyGardent() {
    ...
    axios.post(`${store.api}/api/lake`, form, store.header)
        .then(response => {
            getGardent()
            getGardentSlot()
            store.loading = false
...
function upgrateGardent() {
    ...
    axios.get(`${store.api}/api/lake/upgrate`, store.header)
        .then(response => {
            getGardent()
            store.noti = {
                'title': 'success',
...
function buySlot() {
    ...
    axios.post(`${store.api}/api/lake/slot`, {}, store.header)
        .then(response => {
            getGardentSlot()
            store.noti = {
                'title': 'success',
